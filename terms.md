...
삼백(이하 "앱")은 HSK(한어수평고시) 대비 중국어 어휘 학습을 돕기 위해 독립적으로 개발된 iOS 애플리케이션입니다. 앱은 HSK를 주관하는 중국국제중문교육기금회(CTI)와 무관합니다. 앱은 레벨(점수대)별 학습 콘텐츠를 제공하며, 레벨은 1급부터 6급까지 여섯 급수. 각 레벨의 단어는 생물학, 천문학, 물리학처럼 학문 주제별 책으로 묶여 있고, 첫 주제 책은 무료로, 나머지 주제 책은 앱 내 구매(이용권)를 통해 이용할 수 있습니다.
...
- HSK(한어수평고시)는 중국국제중문교육기금회(CTI)가 주관하는 시험입니다. 본 앱은 "시험 대비"라는 서비스의 목적을 설명하기 위한 서술적 용도로만 상표를 언급하며, 중국국제중문교육기금회(CTI)와 무관하고 주관 기관의 제휴나 보증, 승인을 받지 않았습니다.
...
- 문의: [이메일 보내기](mailto:forgelab.aitech@gmail.com?subject=%5BSanbai%5D%20%EC%9D%B4%EC%9A%A9%EC%95%BD%EA%B4%80%20%EB%AC%B8%EC%9D%98)
...
Sanbai ("the App") is an independently developed iOS application that helps users study Chinese vocabulary in preparation for the Chinese proficiency test HSK (Hanyu Shuiping Kaoshi). The App is not affiliated with, endorsed or approved by Chinese Testing International (CTI). The App provides study content organized by level (score band), and there are four levels: 0-60, 61-80, 81-100 and 101-120. Within each level the words are grouped into subject books such as Biology, Astronomy and Physics; the first subject book is free, and the remaining subject books can be unlocked through an in-app purchase (a pass).
...
- HSK is administered by Chinese Testing International (CTI). The mark is used solely in a descriptive (nominative) manner to indicate the purpose of the App, which is test preparation. This App is not affiliated with, endorsed, or approved by 중국국제중문교육기금회(CTI).
...
- Contact: [Send us an email](mailto:forgelab.aitech@gmail.com?subject=%5BSanbai%5D%20Terms%20inquiry)
